...
Adafruit_MQTT_Publish status  = Adafruit_MQTT_Publish(&mqtt, "sensor/motion/3");
Adafruit_MQTT_Publish motion_topic  = Adafruit_MQTT_Publish(&mqtt, "sensor/motion/3");
